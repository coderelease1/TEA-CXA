    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            if "image_path" in test_batch.non_tensor_batch:
                non_tensor_batch_keys_to_pop.append("image_path")
            if "x-ray info" in test_batch.non_tensor_batch:
                non_tensor_batch_keys_to_pop.append("x-ray info")
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                if "image_path" in batch.non_tensor_batch:
                    non_tensor_batch_keys_to_pop.append("image_path")
                if "x-ray info" in batch.non_tensor_batch:
                    non_tensor_batch_keys_to_pop.append("x-ray info")
