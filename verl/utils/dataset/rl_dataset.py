    ...
    def maybe_filter_out_long_prompts(self, dataframe: datasets.Dataset = None):
        ...
        if self.filter_overlong_prompts:
            ...
            if processor is not None:
                from verl.utils.dataset.vision_utils import process_video #process_image, 
    ...
    def __getitem__(self, item):
        ...
        if self.processor is not None:
            ...
            if self.image_key in row_dict and row_dict.get(self.image_key, None) is not None:
                #row_dict[self.image_key] = [os.path.join("/home/xmed/zahuai/RL-Factory",p) for p in row_dict[self.image_key]]
                row_dict["image_path"] = row_dict[self.image_key]
                #row_dict["x-ray info"] = {"context": "", "ImageViewPosition": ["UNKNOWN"]*7}
                #row_dict["id"] = row_dict["question_id"]
